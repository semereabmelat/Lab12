...
namespace SMS.Data.Services
{
    public class StudentServiceDb : IStudentService
    {
        ...
        public StudentModule UpdateStudentModuleMark(int studentId, int moduleId, int mark)
        {
            var student = GetStudent(studentId);
            ...
            var sm = student.StudentModules.FirstOrDefault(o => o.ModuleId == moduleId);
            if (sm == null)
            {
                return null; // no such student module
            }

            // update student module mark
            sm.Mark = mark;
